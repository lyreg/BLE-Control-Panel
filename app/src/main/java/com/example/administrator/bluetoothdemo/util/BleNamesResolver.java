...
public class BleNamesResolver {
    ...
    static public String resolveProperties(int props) {
        String propertiesString = String.format("0x%04X\n[ ", props);
    ...
    static public boolean hasReadProperty(int props) {
        if ((props & BluetoothGattCharacteristic.PROPERTY_READ) != 0) {
            return true;
        }
        return false;
    }
    static public boolean hasWriteProperty(int props) {
        if ((props & BluetoothGattCharacteristic.PROPERTY_WRITE) != 0) {
            return true;
        }
        return false;
    }
    static public boolean hasNotifyProperty(int props) {
        if ((props & BluetoothGattCharacteristic.PROPERTY_NOTIFY) != 0) {
            return true;
        }
        return false;
    }
    static public boolean hasIndicateProperty(int props) {
        if ((props & BluetoothGattCharacteristic.PROPERTY_INDICATE) != 0) {
            return true;
        }
        return false;
    }
    static public boolean hasWriteNoRespProperty(int props) {
        if ((props & BluetoothGattCharacteristic.PROPERTY_WRITE_NO_RESPONSE) != 0) {
            return true;
        }
        return false;
